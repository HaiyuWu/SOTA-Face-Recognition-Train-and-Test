...
from backbones.adaface_resnet import build_model
import sys
sys.path.append("..")
...
class Test:
    def __init__(self, args):
        ...
        self.model = self.create_model(args.depth, args.net_mode, args.model_path)
    ...
    def create_model(self, depth, net_mode, model_path):
        model = build_model(f"{net_mode}_{depth}")
        statedict = torch.load(model_path)['state_dict']
